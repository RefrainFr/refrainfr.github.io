...
**Remark.** A slight modification of this argument can be used to prove \(S_P^2\xrightarrow{L^2}T\), that is by proving \(\lim_{\|P\|\to 0}\text{E}[(S_P^2-T)^2] = 0 \).

## Slight remark
A slight modification of this argument can be used to prove $S_P^2\xrightarrow{L^2}T$, that is, by proving $\lim_{\|P\|\to 0}\E[(S_P^2-T)^2] = 0 $.
