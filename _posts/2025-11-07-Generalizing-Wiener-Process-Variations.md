...
<p align="justify">  
Last week, we discussed the first two variations in the Stochastic Analysis class, and I suddenly remembered that I had done the same thing before. So yeah, as I haven't tried to update anything on my page lately, let's just try to solve this simple problem. Thank you [the internet](https://math.stackexchange.com/questions/92648/calculation-of-the-n-th-central-moment-of-the-normal-distribution-mathcaln) for providing me such a great identity that I can abuse in the future! Let us cook now!
</p>
# The Problem
<p align="justify">  
